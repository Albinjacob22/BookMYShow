        ...
        <div>
          ...
          <div className="flex flex-col gap-4 text-white">
            ...
            <div className='flex items-center flex-wrap gap-4 mt-4'>
              <button className='flex  items-center gap-2 px-7 py-3 text-sm bg-gray-800 hover:bg-gray-900 transition roundede-md font-medium cursor-pointer active:scale-95'>
